...
%Zum Debuggen der Tikz-Bilder lässt sich die preview-Umgebung nutzen
...
\input{content/aufgabenstellung.tex}
\input{content/fragenteil.tex}
\input{content/kontrollausgaben.tex}
\input{content/modulbeschreibung.tex}
...
\appendix
\pagenumbering{Roman}
\lstinputlisting[label=lst:main]{./listing/main.a51}
