...
\usepackage{eso-pic} % needed for background-image
...
\usepackage[
   ...
   %fleqn,     % Position equations at a fixed t from the left margin rather than
...
%\bibliographystyle{babalpha-fl}% standard der vorlage
%\bibliographystyle{bib/aps}
\usepackage{scrhack}		%verhindert ngwarning bei bibliography
...
%\usepackage{cite} %% mehrere Referenzen in einer Klammer richtig sortieren
...
% Paper Groesse
   ...
   %paperwidth=210mm,
   %paperheight=297mm,
   %papersize={210mm,297mm}, %{ width , height }
   %landscape,  % Querformat
   portrait,    % Hochformat
 %% Koerper Groesse
   hscale=0.75,%0.715      % ratio of width of total body to \paperwidth
                  % hscale=0.8 is equivalent to width=0.8\paperwidth. (0.7 by default)
   vscale=0.75,%0.75      % ratio of height of total body to \paperheight
                  % vscale=0.9 is equivalent to height=0.9\paperheight.
   %scale={0.7 , 0.8},       % ratio of total body to the paper. scale={ h-scale , v-scale }
   ...
   %total={ 16cm , 23.7cm },        % total={ width , height }
   %textwidth=,    % modifies \textwidth, the width of body
   %textheight=30cm,   % modifies \textheight, the height of body
 ...
 %% Margin
   %left=10mm,        % left margin (for oneside) or inner margin (for twoside) of total body
                  % alias: lmargin, inner
   %right=10mm,       % right or outer margin of total body
                  % alias: rmargin outer
   top=0.12\paperheight,%0.12,         % top margin of the page.
                  % Alias : tmargin
   %bottom=40mm,      % bottom margin of the page
                  % Alias : bmargin
   ...
   %vmarginratio=1:2, % vertical margin ratio of top to bottom.
 ...
 %% Dimensionen
   ...
   footskip=0.03\paperheight,    % distance separation between baseline of last line of text and baseline of footer
                  % Alias: foot
...
\definecolor{sectioncolor}{RGB}{0,25,150}    % Blau (dunkler)
...
\definecolor{pdfurlcolor}{RGB}{100,0,0}		%	Rot (dunkler)
\definecolor{pdffilecolor}{RGB}{0,100,0}	% Grün
\definecolor{pdflinkcolor}{RGB}{0,25,150}	% Blau (dunkler)
\definecolor{pdfcitecolor}{RGB}{0,25,150}	% Blau (dunkler)
...
\listfiles
%------------------------------------------------------------------------
\usepackage{ifthen} % If/then-Abfragen ermöglichen
\usepackage[absolute]{textpos} % Freie Positionierung von Text oder Bildern ermöglichen
\usepackage{floatflt}	% Floating-Text ermöglichen
\usepackage{enumitem} % Ermöglicht das Ändern der itemize- und enumerate-Umgebung
